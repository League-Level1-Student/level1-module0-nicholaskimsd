...
public class DrumKit implements MouseListener {
    ...
    String jow= "drum set.jpg";
   	 // 9. Edit the next line to use your String variable
 drumLabelWithImage = createLabelImage(jow);
   	 
   	 // 10. Add the image to the panel
    ko.add(drumLabelWithImage);
   	 // 11. Set the layout of the panel to "new GridLayout()"
    ko.setLayout(new GridLayout());
      	 // 12. call the pack() method on the Jframe.  Run your program. Do you see your drum image?
   	  hi.pack();
